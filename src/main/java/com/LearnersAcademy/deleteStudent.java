	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(conn!=null) {
			try {
				...
				if(rowsInserted > 0) {
					System.out.println("The student details has been deleted.");
					out.println("<center> <span style='color:red'><br><h3>The student details has been deleted. <h3></span></center>");
