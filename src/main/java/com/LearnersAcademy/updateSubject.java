	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(conn!=null) {
			try {
				...
				String sql = "UPDATE subject SET subject = ?, class_id = ? WHERE sub_id = ?";
				...
				if(rowsInserted > 0) {
					System.out.println("Subject list has been Updated.");
					out.println("<center> <span style='color:red'><br> Subject list has been Updated.! </span></center>");
